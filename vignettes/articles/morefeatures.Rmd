...
Use `addGraticule()` to add a graticule (grid) to the map (via the [Leaflet.Graticule](https://github.com/turban/Leaflet.Graticule) plugin).
...
You can use `addMiniMap()` to add a minimap to aid in navigation. This is implemented via the [Leaflet-MiniMap](https://github.com/Norkart/Leaflet-MiniMap) plugin.
