...
#'   \url{http://leafletjs.com/reference-1.3.4.html#zoom/pan-options})
#' @references \url{http://leafletjs.com/reference-1.3.4.html#map-methods-for-modifying-map-state}
