...
#' popup options; see \url{https://leafletjs.com/reference.html#popup-option}
...
#' label options; see \url{https://leafletjs.com/reference.html#tooltip-option}
#' @param opacity Tooltip container opacity. Ranges from 0 to 1. Default value is \code{1} (different from leaflet.js \code{0.9}); see \url{https://leafletjs.com/reference.html#tooltip-opacity}
...
#' @param sticky If true, the tooltip will follow the mouse instead of being fixed at the feature center. Default value is \code{TRUE} (different from leaflet.js \code{FALSE}); see \url{https://leafletjs.com/reference.html#tooltip-sticky}
...
#'   marker options; see \url{https://leafletjs.com/reference.html#marker-option}
...
#' @param spiderLegPolylineOptions Allows you to specify PolylineOptions (\url{https://leafletjs.com/reference.html#polyline-option}) to style spider legs. By default, they are { weight: 1.5, color: "#222", opacity: 0.5 }
...
#' \href{https://leafletjs.com/reference.html#control-layers}{layers control}
