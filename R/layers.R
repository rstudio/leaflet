...
#'   \url{http://leafletjs.com/reference-1.3.4.html}
...
#' \url{http://leafletjs.com/reference-1.3.4.html#tilelayer}
...
#' popup options; see \url{http://leafletjs.com/reference-1.3.4.html#popup-option}
...
#' label options; see \url{http://leafletjs.com/reference-1.3.4.html#tooltip-option}
#' @param opacity Tooltip container opacity. Ranges from 0 to 1. Default value is \code{1} (different from leaflet.js \code{0.9}); see \url{http://leafletjs.com/reference-1.3.4.html#tooltip-opacity}
...
#' @param sticky If true, the tooltip will follow the mouse instead of being fixed at the feature center. Default value is \code{TRUE} (different from leaflet.js \code{FALSE}); see \url{http://leafletjs.com/reference-1.3.4.html#tooltip-sticky}
...
#'   marker options; see \url{http://leafletjs.com/reference-1.3.4.html#marker-option}
...
#' @param spiderLegPolylineOptions Allows you to specify PolylineOptions (\url{http://leafletjs.com/reference-1.3.4.html#polyline-option}) to style spider legs. By default, they are { weight: 1.5, color: "#222", opacity: 0.5 }
...
#' \href{http://leafletjs.com/reference-1.3.4.html#control-layers}{layers control}
