...
#' @param position standard \href{http://leafletjs.com/reference-1.3.4.html#control-positions}{Leaflet control position options}.
...
#'           Properties may be any \href{http://leafletjs.com/reference-1.3.4.html#popup-option}{standard Leaflet popup options}.
