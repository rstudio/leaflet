...
#' @param position standard \href{https://leafletjs.com/reference.html#control-positions}{Leaflet control position options}.
...
#'           Properties may be any \href{https://leafletjs.com/reference.html#popup-option}{standard Leaflet popup options}.
