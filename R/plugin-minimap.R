...
#'    a Path.Options (\url{http://leafletjs.com/reference-1.3.4.html#path-options}) object.
...
#'    a Path.Options (\url{http://leafletjs.com/reference-1.3.4.html#path-option}) object.
#'    (Clickable will always be overridden and set to false.)
