...
For convenience leaflet provides a `providers` list, prepopulated with all the third-party tile providers supported by the leaflet-providers plugin. This enables you to use auto-completion feature of your favorite R IDE (like RStudio) and not have to remember or look up supported tile  providers.
